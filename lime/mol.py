...
from lime.oqs import correlation_2p_1t, lindblad
from lime.phys import driven_dynamics, quantum_dynamics

class Mol:
    def __init__(self, ham, dip, gamma=None):
        """
...
#        self.deex = np.triu(dip)
    ...
    def eigenstates(self, sparse=False, k=6):
        if sparse == False:
            ...
            return linalg.eigs(self.H, k=k, which='SR')
    ...
    def driven_dynamics(self, pulse, dt=0.001, Nt=1, obs_ops=None, nout=1, t0=0.0):
        ...
        driven_dynamics(ham, dip, psi0, pulse, dt=dt, Nt=Nt, \
